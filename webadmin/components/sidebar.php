            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <?php if ($_SESSION['user_data']['role'] == "2") : ?>
                                <li><a href="create-category.php">Add a Category</a></li>
                            <?php endif; ?>

                            <li><a href="view-categories.php">View All Categories</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <?php if ($_SESSION['user_data']['role'] == "2") : ?>
                                <li><a href="create-product.php">Create a New Product</a></li>
                            <?php endif; ?>
                    ...
                    <?php if ($_SESSION['user_data']['role'] == "2") : ?>
                        ...
                        <li><a class="" href="view-payments.php" aria-expanded="false">
                                <div class="menu-icon">
                    ...
                    <?php if ($_SESSION['user_data']['role'] == "2") : ?>
                        ...
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                                ...
                                <span class="nav-text">Shipping Address</span>
                            </a>
                            <ul aria-expanded="false">
                                <li><a href="create-shipping.php">Add a Shipping Address</a></li>
                                <li><a href="view-shippings.php">View Shipping Addresses</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="create-coupon.php">Create Coupon Code</a></li>
                                <li><a href="view-coupons.php">View All Coupon Codes</a></li>
                            </ul>
                        </li>

                    <?php endif; ?>

                    <li><a class="" href="contacts-requests.php" aria-expanded="false">
                            <div class="menu-icon">
