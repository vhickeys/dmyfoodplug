				...
				<nav class="navbar navbar-expand">
					<div class="collapse navbar-collapse justify-content-between">
						...
						<ul class="navbar-nav header-right">
							<form action="classes/process.php?action=logout" method="post">
								<button class="btn btn-primary btn-sm mt-2">Logout</button>
							</form>
									...
									<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
										...
										<div class="header-info2 d-flex align-items-center">
											...
											<div class="header-info">
												<h6><?php echo $_SESSION['user_data']['fullName'] ?? 'Anonymous'; ?></h6>
												<p><?php echo $_SESSION['user_data']['email'] ?? 'anonymous@email.com'; ?></p>
											</div>
									...
									<div class="dropdown-menu dropdown-menu-end">
										<div class="card border-0 mb-0">
											<div class="card-header py-2">
												<div class="products">
													<img src="images/avatar/1.png" class="avatar avatar-md" alt="">
													<div>
														<h6><?php echo $_SESSION['user_data']['fullName'] ?? 'Anonymous'; ?>
														</h6>
														<span><?php echo $_SESSION['user_data']['role'] == "2" ?  'Super Admin' : 'Admin' ?? 'anonymous@email.com'; ?></span>
													</div>
												</div>
											</div>
											<div class="card-body px-0 py-2">
												...
												<a href="view-products.php" class="dropdown-item ai-icon ">
												...
												<a href="contacts-requests.php" class="dropdown-item ai-icon ">
													<svg width="20" height="20" viewBox="0 0 24 24" fill="none"
														xmlns="http://www.w3.org/2000/svg">
														<path fill-rule="evenodd" clip-rule="evenodd"
													...
													<span class="badge badge-sm badge-secondary light rounded-circle text-white ms-2"><?= $record->countRecords("contacts") ?? ""; ?></span>
											...
											<div class="card-footer px-0 py-2">
												...
												<a href="javascript:void(0)" class="dropdown-item ai-icon">
													...
													<form action="classes/process.php?action=logout" method="post">
														<button class="btn btn-primary btn-sm mt-2 w-100">Logout</button>
													</form>
												</a>
											</div>
										</div>
